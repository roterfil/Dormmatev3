...
export const getTenantByUsername = async (username) => {
    const response = await api.get(`/tenants/byUsername/${username}`);
    return response.data;
};
export const createTenant = async (tenantData, userId, unitId) => {
  const response = await api.post(`/tenants?unitId=${unitId}`, tenantData);
return response.data;
};
...
export const createAnnouncement = async (announcementData, userId) => {
    const response = await api.post(`/announcement?userId=${userId}`, announcementData);
    return response.data;
};
export const updateAnnouncement = async (announcementId, announcementData) => {
  const response = await api.put(`/announcement/${announcementId}`, announcementData);
  return response.data;
};
